...
2. **🛠️ Native Agentic Tool Calling (100% Invocation Accuracy)**:
   * Emits structured `<tool_call>` JSON blocks to offload exact multi-digit math to a `calculator` tool (`123433 * 564332 = 69657191756`) and live real-time queries to `search_web`.
3. **💭 Chain-of-Thought (`<think>`) Reasoning**:
...
* **SLERP Manifold Fusion**: Merged specialized reasoning and agentic manifolds via Spherical Linear Interpolation to eliminate capability interference.
