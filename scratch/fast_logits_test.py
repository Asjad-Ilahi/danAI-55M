...
# Train small 4-layer model for fast diagnosis on CPU
...
print("Training 4-layer model on CPU for 100 steps...")
model.train()
...
# Test Generation with prompt prefix (9 tokens)
generator = TextGenerator(model, tokenizer, torch.device("cpu"))
prompt = "Once upon a time, in a bright green"

print("\n--- GENERATION TEST (Prompt: 'Once upon a time, in a bright green') ---")
print("WITH KV CACHE:")
